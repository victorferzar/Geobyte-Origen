...
namespace geologycmcc.Controllers.Graficos.GeologiaQAQC
{
    public class GraficosClass
    {
        ...
        public Highcharts ChartIRM(IEnumerable<CQAQCSTD> datosFiltrados, string TipoDat, string desde, string hasta, string nombregrafico)
        {
            ...
            /* var datosCount = datosFiltrados.Count();
             var datosCountRech = datosFiltrados.Where(x => x.ASSAY_PRIORITY >= 3).Count();
             ...
             var normalizacionNoRech = new object[datosCount - datosCountRech];
                 ...
                 if (TipoDat == "BLANK")
                 {
                     if (item.ASSAY_PRIORITY >= 3)
                     {
                         normalizacionRech[tempCountRech] = new Points
                         {
                             ...
                             {
                                 FillColor = item.ASSAY_PRIORITY >= 3 ? System.Drawing.Color.Red : Color.Green,
                             },
